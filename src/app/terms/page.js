...
const page = () => {
  return (
    <div className="p-[2rem]">
      ...
      <p>Welcome to Satva Nutrition!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Satva Nutrition&apos;s Website, located at flextransformation.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Satva Nutrition if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Satva Nutrition, you agreed to use
        cookies in agreement with the Satva Nutrition&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Satva Nutrition and/or its licensors own the
        intellectual property rights for all material on Satva Nutrition. All
        intellectual property rights are reserved. You may access this from Satva Nutrition for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Satva Nutrition</li>
        <li>Sell, rent or sub-license material from Satva Nutrition</li>
        <li>Reproduce, duplicate or copy material from Satva Nutrition</li>
        <li>Redistribute content from Satva Nutrition</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Satva Nutrition does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Satva Nutrition,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Satva Nutrition shall not be liable for
      ...
      <p>
        Satva Nutrition reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Satva Nutrition a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Satva Nutrition; and (d) the link is
      ...
      <p>
        ...
        e-mail to Satva Nutrition. Please include your name, your organization name,
      ...
      <p>
        No use of Satva Nutrition&apos;s logo or other artwork will be allowed for linking
